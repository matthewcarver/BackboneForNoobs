define(['backbone', 'views/register', 'views/bills'],
    function(Backbone, RegisterView, BillsView){
    ...
    var AppRouter = Backbone.Router.extend({
                                               ...
                                               defaultAction: function(actions){
                                                   var v = new RegisterView(); // if you want to load a view by default
                                               },
                                               register: function(actions){
                                                   var v = new RegisterView();
                                               },
